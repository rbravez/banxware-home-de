...
## Results
The SQL queries to answer the specific business questions (Top products, top customers, etc) is located in the `queries/` folder. These scripts are designed to be run once the pipeline has finished.
